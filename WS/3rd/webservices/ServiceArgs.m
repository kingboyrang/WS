...
//static NSString *defaultWebServiceUrl=@"http://223.4.216.54/TFWSYDHLJLPT/ShouHouFuWu.asmx";
//static NSString *defaultWebServiceNameSpace=@"http://tempuri.org/";

static NSString *defaultWebServiceUrl=defaultWebserviceURL;
static NSString *defaultWebServiceNameSpace=defaultWebserviceSpace;
